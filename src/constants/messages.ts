export const messages = {
    ...
    try_mint_more: (value: string) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} LWH.`,
    ...
    not_registered: "Your Referral hasn't been registered.",
    ...
    switch_to_bsctestnet: "Switch to the BSC Testnet network?",
